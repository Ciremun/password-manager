...
void ui_update()
{
    ...
    if (ImGui::BeginTabBar("##tab_bar_first_line", ImGuiTabBarFlags_NoCloseWithMiddleMouseButton | ImGuiTabBarFlags_FittingPolicyScroll | ImGuiTabBarFlags_NoTabListScrollingButtons))
    {
